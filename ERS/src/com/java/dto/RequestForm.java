...
public class RequestForm {
	...
	public RequestForm(int reimb_id, double reimb_amount, Date reimb_date, Date resolved_date,
	...
	public RequestForm(Double reimbursementAmount, String description,
			int employee_id, int reimbursementTypeId) {
		//this.reimb_id=reimb_id2;
		this.reimb_amount=reimbursementAmount;
		//this.reimb_date=requestDate;
		this.reimb_description=description;
		this.reimb_author_id=employee_id;
		this.reimb_type_id=reimbursementTypeId;
	}
