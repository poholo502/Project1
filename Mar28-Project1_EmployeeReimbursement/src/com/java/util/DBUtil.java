...
public class DBUtil {
	...
	static {
		...
		try {//getting info from data.properties driverName, url, username, password
			property.load(new FileInputStream("C:\\Users\\Poho\\Desktop\\Project1\\Project1-EmployeeReimbursement\\Mar28-Project1_EmployeeReimbursement\\resources\\data.properties"));
